...
namespace BusinessObjects.Migrations
{
    ...
    [Migration("20260114095655_UpdatePass")]
            ...
            modelBuilder.Entity("BusinessObjects.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(8243),
            ...
            modelBuilder.Entity("BusinessObjects.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7304),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Administrator role with all permissions.",
                            Name = "Admin",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7306),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("4f2dbb46-273e-4aff-b0ae-4a5fa528aaa5"),
                            CreatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7309),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Human Resources.",
                            Name = "HR",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7309),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("5659d538-3a19-4c5a-aec8-2c024cba0f05"),
                            CreatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7311),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Employees.",
                            Name = "Employee",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7311),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("7d4e0498-36dd-478c-ab11-b28c25e9da0f"),
                            CreatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7313),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Board of Directors",
                            Name = "BOD",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7313),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("bc2e856e-0abd-4ca1-9c5f-7f4ea3faa14d"),
                            CreatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7314),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Manager Of Department",
                            Name = "Manager",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2026, 1, 14, 9, 56, 54, 586, DateTimeKind.Utc).AddTicks(7315),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.Models.UserInformation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsUnionMember = false,
                            Status = "Active",
                            UserId = new Guid("12240fc0-2a2a-4b45-9ba5-6a57667413c2")
                        });
                });
