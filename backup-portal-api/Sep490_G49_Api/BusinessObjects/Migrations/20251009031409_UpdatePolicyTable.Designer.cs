...
namespace BusinessObjects.Migrations
{
    ...
    [Migration("20251009031409_UpdatePolicyTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObjects.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3794),
            ...
            modelBuilder.Entity("BusinessObjects.Models.PolicyHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusinessObjects.Models.PolicyHistoryComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PolicyHistoryId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("PolicyHistoryId");

                    b.ToTable("PolicyHistoryComment");
                });

            modelBuilder.Entity("BusinessObjects.Models.PolicyHistoryFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PolicyHistoryFile");
                });

            modelBuilder.Entity("BusinessObjects.Models.PolicyHistoryUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusinessObjects.Models.PolicyStepDepartment", b =>
                {
                    ...
                    b.ToTable("PolicyStepsDepartment");
                });
            ...
            modelBuilder.Entity("BusinessObjects.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3095),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Administrator role with all permissions.",
                            Name = "Admin",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3096),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("4f2dbb46-273e-4aff-b0ae-4a5fa528aaa5"),
                            CreatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3098),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Human Resources.",
                            Name = "HR",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3099),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("5659d538-3a19-4c5a-aec8-2c024cba0f05"),
                            CreatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3100),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Employees.",
                            Name = "Employee",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3101),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("7d4e0498-36dd-478c-ab11-b28c25e9da0f"),
                            CreatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3102),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Board of Directors",
                            Name = "BOD",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3102),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("bc2e856e-0abd-4ca1-9c5f-7f4ea3faa14d"),
                            CreatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3103),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Manager Of Department",
                            Name = "Manager",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 9, 3, 14, 8, 331, DateTimeKind.Utc).AddTicks(3103),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 9, 10, 14, 8, 331, DateTimeKind.Local).AddTicks(3725),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DepartmentId = new Guid("7bf10d6a-c521-44be-804e-8f70e6ae26d1"),
                            IsDeleted = false,
                            PasswordHash = new byte[] { 132, 192, 79, 212, 215, 185, 130, 142, 3, 195, 205, 17, 234, 210, 73, 59, 6, 4, 45, 3, 26, 194, 198, 188, 53, 230, 33, 233, 85, 98, 171, 120, 229, 162, 97, 167, 97, 166, 101, 207, 110, 174, 95, 221, 196, 25, 183, 37, 226, 204, 108, 66, 214, 203, 80, 192, 185, 45, 233, 134, 102, 135, 109, 58 },
                            PasswordSalt = new byte[] { 80, 111, 77, 93, 244, 157, 144, 132, 87, 233, 222, 85, 63, 1, 175, 135, 54, 30, 74, 32, 5, 111, 8, 205, 43, 1, 87, 128, 96, 219, 179, 152, 143, 28, 231, 76, 35, 189, 69, 166, 176, 244, 26, 175, 9, 191, 115, 83, 182, 228, 186, 30, 86, 211, 98, 76, 8, 98, 150, 152, 245, 9, 44, 49, 155, 14, 254, 71, 34, 41, 135, 205, 228, 226, 25, 106, 126, 21, 221, 28, 177, 105, 244, 168, 137, 230, 122, 90, 122, 33, 64, 134, 203, 240, 73, 149, 178, 218, 158, 117, 180, 142, 250, 123, 86, 186, 141, 102, 14, 4, 36, 199, 83, 152, 22, 122, 213, 123, 210, 224, 154, 76, 234, 46, 178, 136, 235, 44 },
            ...
            modelBuilder.Entity("BusinessObjects.Models.PolicyHistoryComment", b =>
                {
                    b.HasOne("BusinessObjects.Models.PolicyHistory", "PolicyHistory")
                        .WithMany("PolicyHistoryComments")
                        .HasForeignKey("PolicyHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PolicyHistory");
                });

            modelBuilder.Entity("BusinessObjects.Models.PolicyHistoryFile", b =>
                {
                    b.HasOne("BusinessObjects.Models.PolicyHistory", "PolicyHistory")
                        .WithMany("PolicyHistoryFiles")
                        .HasForeignKey("PolicyHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusinessObjects.Models.PolicyHistory", b =>
                {
                    b.Navigation("PolicyHistoryComments");

                    b.Navigation("PolicyHistoryFiles");

                    b.Navigation("PolicyHistoryUsers");
                });
