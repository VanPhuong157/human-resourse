...
namespace BusinessObjects.Migrations
{
    ...
    [Migration("20251003041545_AddProjectTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObjects.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(9620),
            ...
            modelBuilder.Entity("BusinessObjects.Models.ProjectDepartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusinessObjects.Models.ProjectFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusinessObjects.Models.ProjectUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusinessObjects.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8850),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Administrator role with all permissions.",
                            Name = "Admin",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8851),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("4f2dbb46-273e-4aff-b0ae-4a5fa528aaa5"),
                            CreatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8853),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Human Resources.",
                            Name = "HR",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8854),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("5659d538-3a19-4c5a-aec8-2c024cba0f05"),
                            CreatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8856),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Employees.",
                            Name = "Employee",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8856),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("7d4e0498-36dd-478c-ab11-b28c25e9da0f"),
                            CreatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8857),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Board of Directors",
                            Name = "BOD",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8858),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("bc2e856e-0abd-4ca1-9c5f-7f4ea3faa14d"),
                            CreatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8859),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Manager Of Department",
                            Name = "Manager",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 3, 4, 15, 45, 226, DateTimeKind.Utc).AddTicks(8859),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 3, 11, 15, 45, 226, DateTimeKind.Local).AddTicks(9566),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DepartmentId = new Guid("7bf10d6a-c521-44be-804e-8f70e6ae26d1"),
                            IsDeleted = false,
                            PasswordHash = new byte[] { 8, 220, 48, 218, 17, 95, 28, 117, 101, 63, 72, 171, 54, 136, 254, 55, 234, 183, 246, 54, 204, 134, 27, 84, 77, 45, 51, 106, 42, 117, 120, 223, 51, 204, 67, 174, 163, 221, 234, 212, 89, 109, 181, 30, 218, 235, 54, 148, 173, 115, 10, 2, 48, 31, 175, 5, 38, 108, 219, 108, 204, 139, 162, 33 },
                            PasswordSalt = new byte[] { 155, 231, 30, 119, 215, 214, 23, 103, 113, 71, 114, 192, 230, 188, 160, 179, 217, 123, 98, 146, 92, 99, 120, 125, 217, 240, 242, 59, 60, 131, 81, 33, 177, 0, 70, 30, 8, 156, 193, 205, 254, 251, 245, 14, 114, 160, 32, 42, 224, 75, 86, 182, 109, 100, 131, 47, 244, 232, 86, 156, 210, 223, 221, 238, 104, 18, 220, 189, 40, 170, 10, 47, 94, 62, 10, 226, 90, 157, 124, 217, 164, 31, 153, 141, 28, 144, 81, 43, 208, 125, 61, 210, 9, 253, 56, 232, 255, 223, 34, 32, 123, 208, 145, 89, 216, 158, 163, 63, 88, 143, 8, 148, 60, 218, 255, 0, 96, 157, 67, 183, 138, 178, 185, 84, 39, 231, 188, 31 },
            ...
            modelBuilder.Entity("BusinessObjects.Models.Project", b =>
                {
                    b.HasOne("BusinessObjects.Models.Project", "Parent")
                        .WithMany("Children")
