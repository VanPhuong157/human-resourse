...
namespace BusinessObjects.Migrations
{
    ...
    [Migration("20240817034334_UpdatePermissionAdminData")]
    partial class UpdatePermissionAdminData
    {
            ...
            modelBuilder.Entity("BusinessObjects.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(5054),
            ...
            modelBuilder.Entity("BusinessObjects.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4047),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Administrator role with all permissions.",
                            Name = "Admin",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4048),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("4f2dbb46-273e-4aff-b0ae-4a5fa528aaa5"),
                            CreatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4050),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Human Resources.",
                            Name = "HR",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4051),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("5659d538-3a19-4c5a-aec8-2c024cba0f05"),
                            CreatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4052),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Employees.",
                            Name = "Employee",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4053),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("7d4e0498-36dd-478c-ab11-b28c25e9da0f"),
                            CreatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4054),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Board of Directors",
                            Name = "BOD",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4055),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("bc2e856e-0abd-4ca1-9c5f-7f4ea3faa14d"),
                            CreatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4056),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Manager Of Department",
                            Name = "Manager",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2024, 8, 17, 3, 43, 33, 887, DateTimeKind.Utc).AddTicks(4057),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
