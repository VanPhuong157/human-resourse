...
namespace BusinessObjects.Migrations
{
    ...
    [Migration("20251016063807_AddPolicyStepDocumentTable")]
    partial class AddPolicyStepDocumentTable
    {
            ...
            modelBuilder.Entity("BusinessObjects.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(2634),
            ...
            modelBuilder.Entity("BusinessObjects.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1694),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Administrator role with all permissions.",
                            Name = "Admin",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1695),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("4f2dbb46-273e-4aff-b0ae-4a5fa528aaa5"),
                            CreatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1698),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Human Resources.",
                            Name = "HR",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1698),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("5659d538-3a19-4c5a-aec8-2c024cba0f05"),
                            CreatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1700),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Employees.",
                            Name = "Employee",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1700),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("7d4e0498-36dd-478c-ab11-b28c25e9da0f"),
                            CreatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1702),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Board of Directors",
                            Name = "BOD",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1702),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("bc2e856e-0abd-4ca1-9c5f-7f4ea3faa14d"),
                            CreatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1703),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Manager Of Department",
                            Name = "Manager",
                            Type = "Basic",
                            UpdatedAt = new DateTime(2025, 10, 16, 6, 38, 6, 647, DateTimeKind.Utc).AddTicks(1704),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
