...
namespace DataAccess.OkrHistories
{
    public class OkrHistoryDAO
    {
        private readonly SEP490_G49Context _context;
        private readonly IMapper _mapper;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public OkrHistoryDAO(SEP490_G49Context context, IMapper mapper, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<IEnumerable<OKRHistoryCommentDTO>> GetComment(Guid okrId)
        {
            var orkH = await _context.okrHistories
                .Where(x => x.OkrId == okrId)
                .OrderByDescending(x => x.DateCreated)  
