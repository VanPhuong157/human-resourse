...
namespace Repository.UserInformations
{
    public class UserInformationRepository : IUserInformationRepository
    {
        ...
        public UserInformationRepository(SEP490_G49Context context, IMapper mapper, IWebHostEnvironment webHostEnvironment, IHubContext<NotificationHub> notificationHub)
        {
            _mapper = mapper;
            _context = context;
